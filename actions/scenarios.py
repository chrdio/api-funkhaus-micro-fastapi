...
async def generate_progression(full_request: PerformanceRequest) -> PerformanceResponse:
    ...
    logger_scenarios.debug(f"Submitted the {data_type} data from request")
    ...
    try:
        ...
        logger_scenarios.debug(f"Parsed a progression from {perf_name}")
    except AttributeError:
        logger_scenarios.debug(f"Can't parse a progression from {perf_name}: requesting a new one")
    ...
    logger_scenarios.debug(f"Requested and submitted a new path.")    
    ...
    logger_scenarios.debug(f"Requested and submitted a new voicing.")    
    ...
    logger_scenarios.debug(f"Requested a new hex-encoded midi.")
    ...
    logger_scenarios.debug(f"Constructed a new performance.")
